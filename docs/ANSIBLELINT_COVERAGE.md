...
- Rule ID mapping: [LINT_RULE_MAPPING.md](LINT_RULE_MAPPING.md)
- Rule doc format: [RULE_DOC_FORMAT.md](RULE_DOC_FORMAT.md)
- To regenerate this table, compare `../ansible-lint/src/ansiblelint/rules/*.py` against `LINT_RULE_MAPPING.md` and the validator rule directories.
